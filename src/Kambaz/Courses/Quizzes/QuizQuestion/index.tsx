...
//   useEffect(() => {
//     // Ensure only the editingQuestion is in edit mode
//     if (questions) {
//       const needsUpdate = questions.some((q: Question) => 
//         (q.isEditing && q._id !== editingQuestion) || 
//         (!q.isEditing && q._id === editingQuestion)
//       );
...
//           ...q,
//           isEditing: q._id === editingQuestion
//         }));
//         dispatch(setQuestions(updatedQuestions));
//       }
//     }
//   }, [editingQuestion, dispatch]); 
...
//       const questionsWithEditState = questionsData.map((q: Question) => ({
//         ...q,
//         isEditing: false, 
//         isNew: false   
//       }));
//       dispatch(setQuestions(questionsWithEditState));
//     } catch (error) {
...
//       points: 1,
//       question: '',
//       quiz: qid, // Include the quiz property
//       choices: ['', '', '', ''],
//       correctAnswer: 0,
//       possibleAnswers: [''],
//       caseSensitive: false,
...
//     if (!isFaculty || editingQuestion !== null) return;
    
//     setEditingQuestion(questionId);
//     dispatch(updateQuestion({ 
//       ...questions.find((q: Question) => q._id === questionId)!,
//       isEditing: true 
//     }));
//   };
...
//         savedQuestion = await questionsClient.createQuestion(qid, questionToSave);
//         dispatch(updateQuestion({ ...savedQuestion, isEditing: false }));
//       } else {
//         // Remove client-side only properties before saving
//         const { isNew, isEditing, ...questionToSave } = questionData;
//         savedQuestion = await questionsClient.updateQuestion(questionData._id, questionToSave);
//         dispatch(updateQuestion({ ...savedQuestion, isEditing: false }));
//       }
...
//     } else {
//       // Just exit edit mode for existing questions using updateQuestion
//       dispatch(updateQuestion({ 
//         ...question!,
//         isEditing: false 
//       }));
...
//       case 'true-false':
//         return <TrueFalseEditor key={question._id + question.type} {...commonProps} />;
//       case 'fill-in-blank':
//         return <FillInTheBlankEditor key={question._id + question.type} {...commonProps} />;
//       default:
//         return <MultipleChoiceEditor key={question._id + question.type} {...commonProps} />;
//     }
//   };

//   const renderQuestionPreview = (question: Question) => (
//     <div key={question._id} className="border rounded p-3 mb-3 bg-white">
